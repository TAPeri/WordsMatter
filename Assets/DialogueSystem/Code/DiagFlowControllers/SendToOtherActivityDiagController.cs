...
public class SendToOtherActivityDiagController : AbsDiagController
{
	...
	public override void prepController()
	{
		...
		//commandQueue.Add(new InventoryDiagCommand("ItemTransferToPlayer",activityObjectPrefab,true,false,true));
