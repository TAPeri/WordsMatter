...
public class ScrollCam : MonoBehaviour
{
	...
	void Update()
	{
		...
		{			
			...
			{
				Vector2 dirVect = prevTouch-currTouch;
				//Vector2 dirVect = currTouch - prevTouch;
				...
				if(useCamExtents)
				{
					...
					{
						//Debug.Log("Moved");
						Camera.main.transform.Translate(dirVect.x,dirVect.y,0);	
						isScrolling = true;
					}
